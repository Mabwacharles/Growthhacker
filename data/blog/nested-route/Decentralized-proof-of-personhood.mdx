...
<ol>
  ...
  To be effective, a Proof of Personhood (PoP) must incorporate a concept of uniqueness. If the PoP
  ...
  challenge for any PoP mechanism.
  <li>
    <strong>Authentication</strong>
  </li> Ensuring the usefulness of PoP credentials involves making them difficult to transfer to prevent
  fraud and protect individuals. Authentication is vital to verify the rightful owner of the PoP credential,
  even if wallets or phones change hands. This approach is akin to airline boarding, where both possession
  of a valid travel document and identity consistency are confirmed for high-integrity use cases. Minimizing
  personal information while tying credentials to unique individuals is crucial in identity systems.
  <li>
    <strong>Recovery</strong>
  </li>
  In cases where the user loses access to their credentials or experiences credential compromise, robust
  recovery mechanisms become essential.
</ol>
