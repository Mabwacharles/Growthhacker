...
<ol>
  <li>
    <strong>Phone hacking:</strong> In the event of a phone being hacked, the hacker could steal the
    key that controls their World ID.
  </li>
  <li>
    <strong>Risks of manipulation:</strong> Possible fraudulent actors may exploit and utilize World
    IDs belonging to other individuals.
  </li>
  <li>
    <strong>Coercion by authoritarian governments to steal IDs</strong>
  </li>
  <li>
    <strong>Orb security;</strong> The Orb which is a hardware used as an Iris scanner maybe subject
    to potential risks on utilization as we know that no hardware systems can be 100% secure.
  </li>
  <li>
    <strong>Personal data privacy concerns:</strong> Concerns from users about the safety of their
...
<ol>
  <li>
    <strong>World ID:</strong> A World ID is a unique identifier assigned to an individual, serving
    as proof of their identity
  </li>
  <li>
    <strong>WLD Tokens:</strong> WLD tokens are distributed to network participants.
  </li>
  <li>
    <strong>World App:</strong> Each Worldcoin user installs an app on their phone, which generates
    a private and public key, this App is refered to as the World App
  </li>
</ol>
